...
return new class extends Migration
{
    ...
    {
        Schema::create('weekly_route_templates', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['weekday', 'employee_id']);
        });

        Schema::create('weekly_route_template_stops', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['weekly_route_template_id', 'stop_order'], 'weekly_route_template_stops_unique_order');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('weekly_route_template_stops');
        Schema::dropIfExists('weekly_route_templates');
    }
};
